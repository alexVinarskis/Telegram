...
//
//public class AvatarSubContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
//
...
//
//    public AvatarSubContainer(Context context, ChatActivity chatActivity, boolean needTime) {
//        this(context, chatActivity, needTime, null);
//    }
//
//    public AvatarSubContainer(Context context, ChatActivity chatActivity, boolean needTime, Theme.ResourcesProvider resourcesProvider) {
//        super(context);
